...
{
    internal class T1_逆时针旋转45_唯一部件_旋转一次_一次事务 : IExternalEventBase
    {
        private TestAssemblyTransfromPlaneModel transfromModel;

        public T1_逆时针旋转45_唯一部件_旋转一次_一次事务(TestAssemblyTransfromPlaneModel transfromModel)
        {
        ...
        public void Execute(UIApplication app)
        {
            ...
            transaction.Start();
            T1_逆时针旋转45_唯一部件_旋转一次_一次事务.Process(doc, assemblyInstance);
            T1_逆时针旋转45_唯一部件_旋转一次_一次事务.Process(doc, assemblyInstance);
            transaction.Commit();
        }
        ...
        {
            return nameof(T1_逆时针旋转45_唯一部件_旋转一次_一次事务);
        }
    }
}
